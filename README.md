...
- **Canvas camera**: Wraps coordinate-bearing U8G2 drawing APIs so an app can
  render content taller than the display and scroll it vertically.
...
- **ListView**: Scrollable menu supporting:
  ...
  - Shared Canvas camera positioning
